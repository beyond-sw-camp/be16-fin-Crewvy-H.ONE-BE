...
* **HR과 협업 도구의 분리:** 인사 정보(조직도, 휴가)는 HR 시스템에, 실제 업무(결재, 화상회의)는 별개의 협업 툴(그룹웨어)에서 이루어집니다. 이는 데이터의 이중 관리, 불필요한 비용 발생, 단절된 사용자 경험을 유발합니다.
...
* **HR과 협업의 유기적 결합:** 조직도, 근태/휴가 정보가 결재, 급여, 화상회의 등 협업 기능과 실시간으로 연동되어, 별도 시스템을 오갈 필요 없는 원스톱(One-stop) 업무 환경을 제공합니다.
...
* **근태 관리:**
    ...
    * (특화) 웹앱기반의 서비스를 제공하여 GPS 연결 확인 등을 이용한 출입 및 근태 자동 기록
