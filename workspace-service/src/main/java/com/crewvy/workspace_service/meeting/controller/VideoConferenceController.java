...
public class VideoConferenceController {
    ...
    public ResponseEntity<?> createVideoConference(@RequestParam(name = "immediate", required = false, defaultValue = "false") boolean immediate,
        ...
        if (immediate) {
            LiveKitSessionRes res = videoConferenceService.createVideoConference(memberId, videoConferenceCreateReq);
    ...
    public ResponseEntity<?> joinVideoConference(@RequestHeader("X-User-UUID") UUID memberId,
        ...
        LiveKitSessionRes res = videoConferenceService.joinVideoConference(memberId, videoConferenceId);
    ...
    public ResponseEntity<?> startVideoConference(@RequestHeader("X-User-UUID") UUID memberId,
        ...
        LiveKitSessionRes res = videoConferenceService.startVideoConference(memberId, videoConferenceId);
